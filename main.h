...
int vptr_mmap(u64** vptr, unsigned int addr) { //Mapping registers to the host's memory
...
int wait_flash_operation(u64 op, u64 tag, int* Qnumber, int* ack,int* ack_tag){
	u64 readQ_ready;
	u64 readQ_tag;
	u64 wr_er_status;
	u64 ack_ready;
